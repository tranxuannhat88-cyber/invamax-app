      ...
      <section className="pt-24 pb-20 px-4 bg-background">
        <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold text-foreground leading-tight tracking-tight whitespace-pre-line mb-6">
              {t.hero.headline}
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground whitespace-pre-line mb-10 leading-relaxed max-w-2xl mx-auto md:mx-0">
              {t.hero.subheadline}
            </p>
